...
def train(args, io):
    ...
    source_train_loader = DataLoader(PaddingData(pc_input_num=args.num_points, status='train', aug=True, swapax=swapax_src,
                                                pc_root='data/data_DA/'+args.src_dataset), num_workers=12,
